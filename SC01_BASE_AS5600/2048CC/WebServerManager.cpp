...
String WebServerManager::getIndexHtml() {
    ...
    html += "<title>MIDI Controller Config</title><style>";
    ...
    html += "<div class='header'><h1>🎛️ MIDI Controller Configuration</h1></div>";
    ...
    html += "<div id='pots-tab' class='tab-content'><div class='nav'>";
    ...
    html += "</div><div class='channel-bar'>";
